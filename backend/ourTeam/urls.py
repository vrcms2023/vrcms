...
urlpatterns = [
    path('createteam/', OurTeamListCreateView.as_view(), name="create_get_our_team"),
    path('UpdateOurteamDetail/<pk>/', OurTeamRetrieveUpdateDestroyView.as_view(), name='retrieve_update_delete_our_team'),
