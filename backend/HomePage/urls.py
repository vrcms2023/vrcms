...
urlpatterns = [
    path('createCarousel/<type>/', CarouselAPIView.as_view(), name="create_get_Carousel"),
    path('getCarousel/<category>/', ServiceCarouselAPIView.as_view(), name="get_service_Carousel"),
