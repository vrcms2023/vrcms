...
export const natureofprojectOptions = [
  { label: "Select Nature of Project", value: "" },
  { label: "MEPF Service", value: "MEPF Service" },
  { label: "BIM Service", value: "BIM Service" },
  { label: "Structural Engineering", value: "Structural Engineering" },
  { label: "Fabrication shop drawing", value: "Fabrication shop drawing" },
  { label: "Auto CAD Drafting", value: "Auto CAD Drafting" },
  { label: "Architectural services", value: "Architectural services" },
  { label: "Facade Shop Drawing", value: "Facade Shop Drawing" },
  { label: "Interior design services", value: "Interior design services" },
  { label: "3D Modeling", value: "3D Modeling" },
  { label: "Precast Detailing", value: "Precast Detailing" },
  {
    label: "Door and Window Shop Drawing",
    value: "Door and Window Shop Drawing",
  },
  { label: "Window shop drawing", value: "Window shop drawing" },
  { label: "Rebar Detailing", value: "Rebar Detailing" },
